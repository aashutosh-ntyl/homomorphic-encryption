...
public class Signup extends javax.swing.JFrame {
    ...
    private void SignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpActionPerformed
        ...
        else if((pf1.getText().length()!=0)||(pf2.getText().length()!=0))
        {
             ...
             {
        		System.out.print("a");
        		if(Pattern.matches("[A-Za-z ]+", tf1.getText())&&Pattern.matches("^[0-9]{10}", tf3.getText())&&Pattern.matches("^[a-z0-9._-]+@[a-z0-9.-]+\\.[a-z]{2,4}$", tf4.getText())&&Pattern.matches("^[A-Za-z0-9 ]+", tf5.getText()))
        		{
                  try{  
