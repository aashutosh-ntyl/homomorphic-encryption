...
public class LogCreator extends JFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		try 
		{
            ...
            fileWriter = new FileWriter(new File("S:\\Transections.txt"));
				...
				else
				{
					...
					if(rs.getInt(6)==0)
					{
						...
						if(email.isEnabled()==false)
							{
								JOptionPane.showMessageDialog(this,"Incorrect Account No.","Error",JOptionPane.INFORMATION_MESSAGE);
							}
                        ...
                        else if(arg0.getSource()==email)
                        {
                            ...
                            sm.mail(Integer.parseInt(acc.getText()), mail, "log", "0", "","S:\\Transections.txt");
                            JOptionPane.showMessageDialog(this,"Email Sucessfully sent !!","Balance",JOptionPane.INFORMATION_MESSAGE);
